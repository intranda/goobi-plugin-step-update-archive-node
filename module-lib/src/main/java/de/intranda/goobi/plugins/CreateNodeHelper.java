...
public class CreateNodeHelper {
    ...
    public CreateNodeHelper(Step step) {
        this.step = step;
        process = step.getProzess();

        // read parameters from correct block in configuration file
        pluginConfig = ConfigPlugins.getProjectAndStepConfig("intranda_step_update_archive_node", step);
